// $Id: Bs2JpsiPhi_Signal_v9.h,v 1.1 2009/12/06  Pete Clarke Exp $
/** @class Bs2JpsiPhi_Signal_v9
 *
...
#ifndef Bs2JpsiPhi_Signal_v9_H
#define Bs2JpsiPhi_Signal_v9_H
...
//============================================================================================
class Bs2JpsiPhi_Signal_v9 : public BasePDF
{
	public:
		Bs2JpsiPhi_Signal_v9( PDFConfigurator* );
		~Bs2JpsiPhi_Signal_v9();
	...
	private:
		...
		double calculateTimeFactor( double ak, double bk, double ck, double dk );
		double calculateTimeFactorInt( double ak, double bk, double ck, double dk );
		...
		ObservableRef GsGdName;		// delta gamma_s - gamma_d
		...
		//.....................
		// C, D, S
		inline double DD() const { return _DD ; } //  _cosphis ; }
		inline double SS() const { return _SS ; } //  _sinphis ; }
